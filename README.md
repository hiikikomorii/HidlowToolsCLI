...
![fakermain.png](assets/fakermain.png)  
...
![currencymain.png](assets/currencymain.png)  
![btcscr.png](assets/btcscr.png)
![tonscr.png](assets/tonscr.png)
...
![fakermain.png](assets/fakermain.png)
![fakereng.png](assets/fakereng.png)

**8. ``Currency`` - shows the current rates for ``BTC`` and ``TON``.
Uses the Coinpaprika API
 and outputs rates in ``RUB`` & ``USD``** ![currencymain.png](assets/currencymain.png)  
![btcscr.png](assets/btcscr.png)
![tonscr.png](assets/tonscr.png)
